...
python3 -m grpc_tools.protoc -I . --go_out=./proxy --go_opt paths=source_relative \
--go-grpc_out=./proxy --go-grpc_opt paths=source_relative \
--grpc-gateway_out=./proxy/ --grpc-gateway_opt paths=source_relative \
